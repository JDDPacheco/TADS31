Codigo do Jsp insere_especialidade.jsp
...
<jsp:useBean id="conexao" scope="page" class="banco_dados.conexaoBancoDados.ConexaoBancoDados" />
<jsp:useBean id="especialidade" scope="page" class="banco_dados.conexaoBancoDados.Especialidades" />
<!DOCTYPE html>
<html>
    <head>
