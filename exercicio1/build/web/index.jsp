...
<html>
    ...
    <body>
        <h1 style="text-align: center;"> Cálculo de Área </h1>
        <h2 style="text-align: center;"> Escolha uma Figura Geométrica </h2>
        <a href="form-trapezio.html">Calcular Área de um Trapézio</a><br>
